...
(*
  The decision to write this lemma came
  after writing the proof for the pattern
  in the propositions
*)

Lemma m22_pow_mul_r:
  forall (m : m22) (b c : nat),
    expt_m22 m (b * c) = expt_m22 (expt_m22 m b) c.

Proof.
  intros m b.
  induction b as [ | c' IHc'].

  * intros c.
    simpl.
    (* We have not proven that exponentiating the identity gives
       the identity *)
...
Proposition excercise_twenty_four:
  forall m n: nat,
...
Proof.
  ...
  (*
    If we can prove the matrix (a^b)^c = a^(b*c)
    version of this property, our proof will become
