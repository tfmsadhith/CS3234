...
Lemma uniqueness_lt_lt :
  forall d q1 r1 q2 r2 : nat,
    ...
    q1 = q2 /\ r1 = r2.
Proof.
  intros d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main lt_q1_q2 lt_r1_r2.
...
Lemma uniqueness_lt_eq :
  forall d q1 r1 q2 r2 : nat,
    ...
    q1 = q2 /\ r1 = r2.
Proof.
  intros d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main lt_q1_q2 eq_r1_r2.
...
Lemma uniqueness_lt_gt :
  forall d q1 r1 q2 r2 : nat,
    ...
    q1 = q2 /\ r1 = r2.
Proof.
  intros d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main lt_q1_q2 lt_r2_r1.
...
Lemma uniqueness_eq_lt :
  forall d q1 r1 q2 r2 : nat,
    ...
    q1 = q2 /\ r1 = r2.
Proof.
  intros d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main eq_q1_q2 lt_r1_r2.
  (* easy: use plus_reg_l *)
Admitted.
...
Lemma uniqueness_eq_eq :
  forall d q1 r1 q2 r2 : nat,
    ...
    q1 = q2 /\ r1 = r2.
Proof.
  intros d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main eq_q1_q2 eq_r1_r2.
...
Lemma uniqueness_eq_gt :
  forall d q1 r1 q2 r2 : nat,
    ...
    q1 = q2 /\ r1 = r2.
Proof.
  intros d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main eq_q1_q2 lt_r2_r1.
  symmetry in H_main.
...
Lemma uniqueness_gt_lt :
  forall d q1 r1 q2 r2 : nat,
    ...
    q1 = q2 /\ r1 = r2.
Proof.
  intros d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main lt_q2_q1 lt_r1_r2.
  symmetry in H_main.
...
Lemma uniqueness_gt_eq :
  forall d q1 r1 q2 r2 : nat,
    ...
    q1 = q2 /\ r1 = r2.
Proof.
  intros d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main gt_q1_q2 eq_r1_r2.
  symmetry in H_main.
...
Lemma uniqueness_gt_gt :
  forall d q1 r1 q2 r2 : nat,
    ...
    q1 = q2 /\ r1 = r2.
Proof.
  intros d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main gt_q1_q2 gt_r1_r2.
  symmetry in H_main.
...
Proof.
  ...
  - exact (uniqueness_lt_lt d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main lt_q1_q2 lt_r1_r2).

  - exact (uniqueness_lt_eq d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main lt_q1_q2 eq_r1_r2).

  - exact (uniqueness_lt_gt d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main lt_q1_q2 lt_r2_r1).

  - exact (uniqueness_eq_lt d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main eq_q1_q2 lt_r1_r2).

  - exact (uniqueness_eq_eq d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main eq_q1_q2 eq_r1_r2).

  - exact (uniqueness_eq_gt d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main eq_q1_q2 lt_r2_r1).

  - exact (uniqueness_gt_lt d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main lt_q2_q1 lt_r1_r2).

  - exact (uniqueness_gt_eq d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main lt_q2_q1 eq_r1_r2).

  - exact (uniqueness_gt_gt d q1 r1 q2 r2 lt_r1_Sd lt_r2_Sd H_main lt_q2_q1 lt_r2_r1).
Qed.
